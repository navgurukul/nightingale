  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route exact path="/programing" component={SchoolProgramming}></Route>
        <Route exact path="/shoolDesign" component={SchoolOfDesign}></Route>
        <Route exact path="/SchoolOfBusiness" component={SchoolOfBusiness}></Route>
