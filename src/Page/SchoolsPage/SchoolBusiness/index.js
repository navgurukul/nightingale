    ...
    <>
      ...
      <div class="centered">
        <div className="text-block">
          <h3 className="software-engineering-course-title">School Of Business</h3>
          <p class="software-engineering-course">
            Fully funded course in Business CRM with regular<br></br>
        ...
        <div class="row align-items-center">
          <div class="col-10 col-sm-12 col-md-12 col-lg-10 mx-auto">
            <div class="">
              ...
              <div class="card-body d-flex flex-column align-items-center" >
                <h5 class="text-title title-text">What Will You Learn</h5>
                <ol className="eligibility-list list-group ">
                  <p>Our student led, self-paced business course includes:</p>
                  <li> <span className="fw-bold"> Introduction to Google Suite:</span> Introduction to Google Suite: Learning advanced Google Sheets, slides, and forms</li>
                  <li> <spna className="fw-bold">Introduction:</spna> Customer Relationship Management & Salesforce</li>
                  <li> <span className="fw-bold">Digital Marketing:</span> Website building, Social media marketing & SEO</li>
                  <li> <span className="fw-bold">Data Analytics: </span>Statistics, SQL queries, Tableau</li>
                </ol>
                <span>
