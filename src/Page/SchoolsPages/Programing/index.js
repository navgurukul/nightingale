...
function SchoolProgramming() {
    return (
        <>
            <div className="programing-bg-img col-sm-12 col-lg-12 col-md-12">
                <div className='container-fluid' style={{ marginTop: "180px" }}>
                    <div className='row'>
                        <div className='col-sm-6 col-md-10 col-lg-10 col-xs-6' style={{ margin: "auto" }}>
                            <h5 className='programmingSchooltitle'>School of Programming</h5>
                            <p className='Programingcontent'>Fully-funded course in software engineering with regular<br></br> mentor support</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-9 web-body-1">
                        <div className="p-3 list-group">
                            ...
                            <ol className="programme-details-list">
                                <p className='Activities-title'>Our student-led, self-paced 18-months programming course includes:</p>
