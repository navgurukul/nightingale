...
function SchoolOfBusiness() {
    return (
        <>
            <div className="SchoolOfBUsiness col-sm-12 col-lg-12 col-md-12" style={{ gap: "40px" }}>
                <div className='container-fluid ' style={{ marginTop: "180px" }}>
                    <div className='row'>
                        <div className='col-sm-6 col-md-10 col-lg-10 col-xs-6' style={{ margin: "auto" }}>
                            <h5 className='Schooltitle'>School Of Business</h5>
                            <p className='Programingtext '>Fully funded course in Business CRM with regular<br></br> mentor support</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="container container-section">
                ...
                <div className="row second-row">
                    <div className="col-sm-12 col-lg-8  col-section-2">
                        <h5 className="programme-audience-list text-center">Who This Programme Is For</h5>
                        <div className="">
                            <p className='programme-details-item'>Our student led, self-paced business course includes:</p>
                        </div>
