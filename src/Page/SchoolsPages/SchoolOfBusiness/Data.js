...
export const topics = [
  {
    subtitle: "Introduction to Google Suite:",
    text: "Learning advanced Google Sheets, slides, and forms",
  },
  {
    subtitle: "Introduction:",
    text: "Customer Relationship Management & Salesforce",
  },
  {
    subtitle: "Digital Marketing:",
    text: "Website building, Social media marketing & SEO",
  },
  { subtitle: "Data Analytics:", text: "Statistics, SQL queries, Tableau" },
];
export const JobAssistanceData = [
  {
    JobAssistanceContent:
      "Students will get 100% assistance for securing jobs in roles such as Customer Relationship Representative, CRM Associate, Salesforce Associate & Operations Associate",
  },
];
export const program3Data = [
  {
    ...
    cardText:
      "Assess fundamental skills up to 8th standard level in Mathematics, Logical Reasoning, and English Language.",
  ...
  },
  {
    ...
    cardText:
      "Evaluates 8th standard-level Math and English, similar to the screening test",
    format: "Online",
  ...
  },
  {
    ...
    cardText:
      "Assess cultural alignment, focusing on needs, emotional aspects, and commitment to community",
    format: "Online/Offline",
    eligibility: "Successful candidates from the academic interview",
    additionalInfo:
      "Candidates are either marked 'Failed' or 'In Preparation'. Depending on which re-interview is allowed in 7 to 15 days",
  },
  {
    buttonText: "Stage 4",
