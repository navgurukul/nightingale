...
import BackgroundImg from "./assets/tem_sectiont.png"
import "./style.css";
    ...
    <>
        ...
        <div className="d-flex flex-column justify-content-center w-100 mb-4">
            <div className="container align-items-center d-flex flex-column  justify-content-center w-100 mt-4">
                ...
                <div className='body1 col-12 p-0 col-md-12 section-para align-items-center justify-content-center mt-4'>
                <div className='col-md-12'>
                <img 
                className='bg-video'
                src={require("./assets/campus photo.jpg").default} style={{width:"100%", height:"100%"}}alt="student"/>
                </div>

                <div className="body1 col-12 col-md-12 mt-4 ">
                ...
                <div className=" col-12 p-0 col-md-12 section-para d-flex align-items-center justify-content-center mb-2 mt-3">
                    <p className="body1 w-100" >
                        ...
                        <ul className="ml-4 mt-4 mb-4" >
                            ...
                            <li><span className="fw-bold">Unique Learning Curriculum : </span> NavGurukul's modern curriculum is designed by 
            ...
            <h3 className="mt-2 section-head mb-3 col-sm-12 w-70 align-items-center justify-content-center m-auto p-0  ">
                Hear from a NavGurukul Alumna in how learning at NavGurukul helped in her journey </h3>
