    ...
    <main className="team-page">
      <div className="text-center mx-auto p-4" style={{ maxWidth: "736px" }}>
        ...
        <p className="mb-2" style={{ textAlign: "left", fontSize: "18px" }}>
          ...
          is consciously diverse and inclusive, with 65% of our team members
          being NavGurukul Alumni, and over 67% of team members being women and
                ...
                <div className="tabs mb-4 text-left">
                  ...
                  <ul className="nav nav-tabs flex-column">
                    {[
                      ...
                      >
                        <span className="nav-link text-left mt-2">
                          {teamName}
                        </span>
                      </li>
                    ))}
