...
//                         <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-lg-end justify-content-md-center justify-content-sm-center align-items-center my-md-2 my-sm-2 my-xs-2" style={{border:"2px solid black"}}>
//                             <button
//                                 type="button"
...
//                             </button>
//                         </div>
//                         <div className='col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-lg-start justify-content-md-center justify-content-sm-center align-items-center my-md-2 my-sm-2 my-xs-2' style={{border:"2px solid black"}}>
//                             <button
//                                 type="button"
