...
//                             <h5
//                                 className="media-font mt-4 text-lg-start p-3"
//                                 style={{
//                                     fontFamily: 'Lato',
//                                     fontSize: '32px',
//                                     fontWeight: 700,
...
//                                             onChange={handleChange}
//                                         />
//                                         <label className="section-para body1" htmlFor="BecomeKnowledgePartner">BecomeKnowledgePartner</label>
//                                     </div>
...
//                         style={{ border: "2px solid black", height: "100%", padding: "0" }} // Removed padding from the second column
//                     >
