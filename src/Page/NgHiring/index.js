...
const NgHiring = () => {
  ...
  return (
    <>
      ...
      <div className='container-fluid' style={{ border: "2px solid red", backgroundColor: "lightgray", }}>
        <div className="container" style={{ border: "2px solid black" }}>
          <div className="row py-5">

            <div
              className="col-lg-6 col-md-12 py-3 pr-0 pr-lg-5 column-height"
            ...
            >
              ...
              <p className="section-para body1 w-100 p-2 text-lg-start">
            ...
            <div
              ...
              style={{ border: "2px solid blue" }}
            >
              <div style={{ backgroundColor: "white", borderRadius: "5px", width: "100%" }}>
                <div className="modal-body ">
                  <form onSubmit={handleSubmit}>
                    <div className="form-group">
                      ...
                      <div className="form-group">
                        <label className="d-block mb-3 fw-bold">I would like</label>
                        <div className="d-flex flex-column">
                          <div className="d-flex align-items-center mb-2">
                            <input
                              ...
                              className="mr-2"
                            />
                            <label className='section-para body1' htmlFor="hire">Hire from Us</label>
                          </div>
                          <div className="d-flex align-items-center mb-2">
                    ...
                    <div className="form-group" style={{ maxWidth: "400px", width: "100%", margin: "8px" }}>
                      <input
                        type="text"
                        name="fullName"
                        id="fullName"
                    ...
                    <div className="form-group mt-3" style={{ maxWidth: "400px", width: "100%", margin: "8px" }}>
                      <button
                        type="submit"
                    ...
                    <div className="container section-para body1 w-100">
                      ...
                      <div className="d-flex w-100 justify-content-center">
                        <button
                          ...
                          style={{ width: "360px" }}
                          // Pass the correct form type to the handler
