        ...
        <section className="d-flex flex-column align-items-center our-initiatives">
            ...
            {/* <div className='container mb-4 mt-3'>
                <div className='row justify-content-center'>
                    <h3 className="section-head body1 w-100 p-3 mt-3 mb-4 text-center">Join Our Movement</h3>

                    <div className='col-lg-4 col-md-4 col-sm-12 mb-2 d-flex justify-content-center'>
                        <button
                            type="button"
                            className="btn fw-bold regular-btn px-4"
                            onClick={() => handleOpenForm('Hire from Us')}
                        >
                            Hire from Us
                        </button>
            ...
            {/* <div className='container mb-4 mt-3'>
                <div className='row justify-content-center align-items-center' style={{border:"2px solid black"}}>
                    <h3 className="section-head body1 w-100 p-3 mt-3 mb-4 text-center">Join Our Movement</h3>
                    ...
                    <div className='col-lg-8 col-md-10 col-sm-12 d-flex justify-content-center'>
                        <div className='d-flex flex-column flex-md-row justify-content-between w-100'>
                            <button
                                type="button"
                                className="btn fw-bold regular-btn px-4 mb-2 mb-md-0"
                                onClick={() => handleOpenForm('Hire from Us')}
                                style={{ marginRight: '0.5rem' }} // Adjust spacing as needed
                            >
                                Hire from Us
                            </button>
                            <button
